...
<h3 align="center">Добро пожаловать в систему, ${username}!</h3>
<h3>Список свободных дисков:</h3>
        <br>
...
<c:forEach items="${discsList}" var="disc">
    <tr>
        ...
        <td><a href="freediscs/take/${disc.discId}"><spring:message code="label.take"/></a></td>
    </tr>
</c:forEach>
</table>
    </body>
